% function results = ClusteringMeasureTao(true_labels,cluster_labels,beta)
...
function results = ClusteringMeasure2(true_labels,cluster_labels,beta)
...
results = [ACC, NMI, RandIndx,Purity, Fbeta, Precision, Recall,  AdjRandIndx];
end
